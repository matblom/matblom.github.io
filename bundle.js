...
menu.setAnchorCorner(_menu.Corner.BOTTOM_RIGHT);
menu.quickOpen = true;

/* INIT ADD A TRIP*/
window.initTipATripPage = function () {
    //slider
    var slider = new _slider.MDCSlider(document.querySelector('.mdc-slider'));
    slider.listen('MDCSlider:change', function () {
        return console.log('Value changed to ' + slider.value);
    });
    ...
    fileButton.addEventListener('change', function (e) {
        ...
        window.imageNameHolder = 'trip_thumbnails/' + file.name;
        var storageRef = firebase.storage().ref('trip_thumbnails/' + file.name);
...
/* SUBMIT TRIP IF PICTURE UPLOADED*/
window.writeUserData = function () {
    var title, author, description, imagepath;
    if (window.imageNameHolder === undefined) {
    ...
    imagepath = window.imageNameHolder;
    var slider = new _slider.MDCSlider(document.querySelector('.mdc-slider'));
...
var _temporary = __webpack_require__(26);
...
var _persistent = __webpack_require__(31);
